...
<br/><br/>
## 2. Create your own codespace to run the labs by clicking on the green *<> Code** button at the top right of the page, then select the *Codespaces* tab, and then click on *Create codespace on main*.
<br/><br/>
